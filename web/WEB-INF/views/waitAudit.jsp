                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <c:if test="${waits != null}">
                                    <c:forEach items="${waits}" var="app">
                                        <tr>
                                            ...
                                            <td>
                                                <button id="${app.id}" class="btn btn-outline-primary auditBtn">进行审核</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="auditForm" class="layui-form">
                            <input type="hidden" id="applicationId" name="applicationId"/>
                            <div class="layui-form-item">
                                <label class="layui-form-label">结果</label>
                                <div class="layui-input-block">
                                    <input type="radio" value="TG" name="status" title="通过">
                                    <input type="radio" value="BTG" name="status" title="不通过">
                                </div>
                            </div>
                            <div class="layui-form-item layui-form-text">
                                <label class="layui-form-label">意见</label>
                                <div class="layui-input-block">
                                    <textarea name="auditComment" placeholder="请输入审核意见" class="layui-textarea"></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                                    <button class="layui-btn" type="button" id="auditCommit">立即提交</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    $(function () {
        ...
        $(".auditBtn").click(function () {
            ...
            $("#audit").modal("show")
            //console.info($(".auditBtn").attr("id"));
        })

        $("#auditCommit").click(function () {
            $.ajax({
                type:"post",
                ...
                success:function (res) {
                    if(res.data){
                        layer.msg("审核成功!",{icon:6,time:1500},function () {
                            window.location = "${PATH}/application/waitAudit"
                        })
                    }
                }
            })
